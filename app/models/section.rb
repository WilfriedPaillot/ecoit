class Section < ApplicationRecord
  ...
  validates :title, length: { in: 10..50, message: ' doit contenir entre 10 et 100 caractères' }, on: :create

  #Validates description length
  validates :description, length: { minimum: 50, message: ' doit contenir au moins 150 caractères' }, on: :create
end
